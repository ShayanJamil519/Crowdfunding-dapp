  ...
  return (
    ...
    sm:space-x-4 flex-wrap"
            ...
            <div className="flex justify-between items-center w-full">
              <div className="flex justify-start space-x-2">
                <Identicons
                  ...
                  size={15}
                />
                <small className="text-gray-700">0x93...13f</small>
        ...
        <p className="text-sm font-light">
          ...
          deleniti itaque voluptas officia quas harum delectus explicabo
          mollitia, nulla sunt veniam rem officiis culpa ullam accusantium
          incidunt quisquam hic!
        </p>
